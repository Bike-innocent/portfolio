...
const ResumeContent = () => {
    return (
        ...
        <>
     <section id="resume-content" class="bg-secondary pt-[100px] pb-[120px]" data-aos="zoom-in">
                <div class="container">
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-[60px] xl:gap-[134px] mx-auto">
                        <div className='sm:max-w-[450px] md:max-w-[500px] lg:max-w-[500px] xl:max-w-[600px] mx-auto'>
