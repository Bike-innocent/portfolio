                            ...
                            <div class="px-6 py-7 bg-black-500 rounded-lg transition-all hover:shadow-2xl hover:bg-white group" data-aos="fade-up" data-aos-delay="500">
                                ...
                                <div class="w-12 h-12 bg-white rounded-full shadow flex flex-wrap items-center justify-center transition-all group-hover:bg-black-500 mb-8">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <path d="M12.75 4.5C12.75 4.91422 12.4142 5.25 12 5.25C11.5858 5.25 11.25 4.91422 11.25 4.5C11.25 4.08578 11.5858 3.75 12 3.75C12.4142 3.75 12.75 4.08578 12.75 4.5Z" fill="#3B82F6" />
                                        <path d="M13.5 19.875C13.9142 19.875 14.25 19.5392 14.25 19.125C14.25 18.7108 13.9142 18.375 13.5 18.375H10.5C10.0858 18.375 9.75 18.7108 9.75 19.125C9.75 19.5392 10.0858 19.875 10.5 19.875H13.5Z" fill="#3B82F6" />
                                    </svg>
                                ...
                                <div class="w-12 h-12 bg-white rounded-full shadow flex flex-wrap items-center justify-center transition-all group-hover:bg-black-500 mb-8">
                                    ...
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <g clip-path="url(#clip0_1513_4913)">
                                            ...
                                            <path d="M11.25 18C10.6533 18 10.081 17.7629 9.65901 17.341C9.23705 16.919 9 16.3467 9 15.75V13.5C9 13.3011 9.07902 13.1103 9.21967 12.9697C9.36032 12.829 9.55109 12.75 9.75 12.75C9.94891 12.75 10.1397 12.829 10.2803 12.9697C10.421 13.1103 10.5 13.3011 10.5 13.5V15.75C10.5 15.9489 10.579 16.1397 10.7197 16.2803C10.8603 16.421 11.0511 16.5 11.25 16.5C11.4489 16.5 11.6397 16.421 11.7803 16.2803C11.921 16.1397 12 15.9489 12 15.75V13.5C12 13.3011 12.079 13.1103 12.2197 12.9697C12.3603 12.829 12.5511 12.75 12.75 12.75C12.9489 12.75 13.1397 12.829 13.2803 12.9697C13.421 13.1103 13.5 13.3011 13.5 13.5V15.75C13.5 16.3467 13.2629 16.919 12.841 17.341C12.419 17.7629 11.8467 18 11.25 18Z" fill="#3B82F6" />
                                ...
                                <div class="w-12 h-12 bg-white rounded-full shadow flex flex-wrap items-center justify-center transition-all group-hover:bg-black-500 mb-8">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <g clip-path="url(#clip0_1513_4939)">
                                            ...
                                            <path d="M15.891 14.5388C16.2017 14.5388 16.4535 14.287 16.4535 13.9763C16.4535 13.6657 16.2017 13.4138 15.891 13.4138C15.5803 13.4138 15.3285 13.6657 15.3285 13.9763C15.3285 14.287 15.5803 14.5388 15.891 14.5388Z" fill="#3B82F6" />
                                ...
                                <div class="w-12 h-12 bg-white rounded-full shadow flex flex-wrap items-center justify-center transition-all group-hover:bg-black-500 mb-8">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <g clip-path="url(#clip0_1513_4988)">
                                            ...
                                            <path d="M3.91296 21.9375C2.90492 21.9375 2.08484 21.1174 2.08484 20.1094C2.08484 19.1013 2.90492 18.2812 3.91296 18.2812C4.92101 18.2812 5.74109 19.1013 5.74109 20.1094C5.74109 21.1174 4.92101 21.9375 3.91296 21.9375ZM3.91296 19.3125C3.47356 19.3125 3.11609 19.67 3.11609 20.1094C3.11609 20.5488 3.47356 20.9062 3.91296 20.9062C4.35237 20.9062 4.70984 20.5488 4.70984 20.1094C4.70984 19.67 4.35237 19.3125 3.91296 19.3125Z" fill="#3B82F6" />
